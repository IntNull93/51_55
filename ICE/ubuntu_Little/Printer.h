...
public:
    ...
    void printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d)
    {
        printString(s, b, i, l, f, d, 0);
    }
    void printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Ice::Context& __ctx)
    {
        printString(s, b, i, l, f, d, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_printString(s, b, i, l, f, d, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_printString(s, b, i, l, f, d, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_printString(s, b, i, l, f, d, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_printString(s, b, i, l, f, d, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d)
    {
        return begin_printString(s, b, i, l, f, d, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Ice::Context& __ctx)
    {
        return begin_printString(s, b, i, l, f, d, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_printString(s, b, i, l, f, d, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_printString(s, b, i, l, f, d, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Demo::Callback_Printer_printStringPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_printString(s, b, i, l, f, d, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, bool b, ::Ice::Int i, ::Ice::Long l, ::Ice::Float f, ::Ice::Double d, const ::Ice::Context& __ctx, const ::Demo::Callback_Printer_printStringPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_printString(s, b, i, l, f, d, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void printString(const ::std::string&, bool, ::Ice::Int, ::Ice::Long, ::Ice::Float, ::Ice::Double, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_printString(const ::std::string&, bool, ::Ice::Int, ::Ice::Long, ::Ice::Float, ::Ice::Double, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void printString(const ::std::string&, bool, ::Ice::Int, ::Ice::Long, ::Ice::Float, ::Ice::Double, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual void printString(const ::std::string&, bool, ::Ice::Int, ::Ice::Long, ::Ice::Float, ::Ice::Double, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual void printString(const ::std::string&, bool, ::Ice::Int, ::Ice::Long, ::Ice::Float, ::Ice::Double, const ::Ice::Current& = ::Ice::Current()) = 0;
