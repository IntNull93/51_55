...
class AMI_Hello_sayHello : public ::IceInternal::OutgoingAsync
{
public:
    ...
    bool __invoke(const ::Demo::HelloPrx&, ::Ice::Int, const ::Ice::Context*);
...
typedef ::IceUtil::Handle< ::Demo::AMI_Hello_sayHello> AMI_Hello_sayHelloPtr;
#endif
...
public:
    #ifdef ICEE_HAS_AMI
    bool sayHello_async(const ::Demo::AMI_Hello_sayHelloPtr&, ::Ice::Int);
    bool sayHello_async(const ::Demo::AMI_Hello_sayHelloPtr&, ::Ice::Int, const ::Ice::Context&);
    #endif
